package com.yffd.jecap.admin.base.web.controller;
...
public abstract class BaseController {
    ...
    public void intDate(WebDataBinder dataBinder) {
        ...
        dataBinder.registerCustomEditor(LocalDateTime.class, new CustomDateEditor(dateFormat, true));   //true:允许输入空值，false:不能为空值
    }
    ...
    public String getTokenId() {
        ...
        if (StringUtils.isBlank(tokenId)) {
            ...
            if (null == cookies) return tokenId;
